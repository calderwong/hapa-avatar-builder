...
test("Song Card mint API is authenticated, restart-safe, range-correct, private-split, and timestamp printable", async (t) => {
  ...
  ] }, { id: "b", role: "visualizer", cards: [{ id: "b0", startSeconds: 0, endSeconds: 1, visualization: { sourceId: "isf:api", card: { schemaVersion: "hapa.visualizer-card.v2", id: "isf:api", title: "API Shader", source: { uri: "/static/isf/api.fs", hash: `sha256:${"a".repeat(64)}` } } } }] }], directorV2: { treatmentId: "treatment:api", variantId: "variant:api", variantHash: "api" } };
